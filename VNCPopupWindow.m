...
- (id)initWithFrame:(CGRect)frame centered:(BOOL)bCenter show:(BOOL)bShow orientation:(float)fOrientation style:(popup_style_t)wStyle
{
	if (bCenter)
	{
